...
import { Divider, Drawer, makeStyles, List, ListSubheader } from "@material-ui/core";
import { DashboardOutlined as DashboardIcon, PeopleOutlined as PeopleIcon, ShoppingCartOutlined as CartIcon, FolderOutlined as FolderIcon, ReceiptOutlined as RecieptIcon, AttachMoney as MoneyIcon } from "@material-ui/icons";
...
export default function Sidebar(props) {
  ...
  return (
    <Drawer classes={{ paper: styles.drawerPaper }} className={styles.drawer} onClose={props.onClose ? props.onClose : null} open={props.open} variant={props.variant}>
      ...
      <SidebarList icon={<MoneyIcon />} text="Finanzas" link="/finanzas" variant="h3" onClick={props.onClose ? props.onClose : null} />
      <List subheader={<ListSubheader className={styles.colored}>Administración</ListSubheader>} style={{ position: "absolute", top: 285 }}>
